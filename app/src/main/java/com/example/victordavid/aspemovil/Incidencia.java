...
public class Incidencia extends AppCompatActivity {
    static  TextView fechaIncidencia;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_incidencia);
        fechaIncidencia = (TextView)findViewById(R.id.fecha);
    ...
    public static class TimePickerFragment extends DialogFragment
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            fechaIncidencia.setText(hourOfDay+":"+minute);
        }
    }
    public static class DatePickerFragment extends DialogFragment
        ...
        public void onDateSet(DatePicker view, int year, int month, int day) {
            ...
            fechaIncidencia.setText(day+"/"+month+"/"+year);
        }
    }
}
